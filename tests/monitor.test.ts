...
describe("runMonitorCycle", () => {
  it("checks every room-window combination and emits alerts through state transitions", async () => {
    ...
    expect(result.nextState.records["mul-yam::2026-04-11::2026-04-13"]?.currentStatus).toBe(
      "available"
    );
    expect(result.nextState.records["tenti::2026-04-12::2026-04-14"]?.currentStatus).toBe(
