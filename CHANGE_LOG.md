...
- Added the newly requested room pages [reservationtpPART](https://www.metzoke.co.il/reservationtpPART), [reservationt](https://www.metzoke.co.il/reservationt), and [reservationtNP](https://www.metzoke.co.il/reservationtNP) to [monitor.config.example.json](/Users/yoyopc/repos/availability-monitor/monitor.config.example.json), [PRD.md](/Users/yoyopc/repos/availability-monitor/PRD.md), [README.md](/Users/yoyopc/repos/availability-monitor/README.md), [CURRENT_STATE.md](/Users/yoyopc/repos/availability-monitor/CURRENT_STATE.md), and [HANDOFF.md](/Users/yoyopc/repos/availability-monitor/HANDOFF.md).
- Verified live that the new pages embed room-specific EZgo identifiers `SI=11940` for `reservationtpPART`, `SI=12485` for `reservationt`, and `SI=11934` for `reservationtNP`.
- Changed the committed GitHub Actions cron in [.github/workflows/availability-monitor.yml](/Users/yoyopc/repos/availability-monitor/.github/workflows/availability-monitor.yml) from `*/10` to off-boundary 10-minute intervals (`7,17,27,37,47,57`) to reduce the chance of scheduler delays at crowded cron boundaries.
...
- Fixed a multi-night false positive in [ezgoDirect.ts](/Users/yoyopc/repos/availability-monitor/src/adapters/ezgoDirect.ts) by validating every occupied night in the stay window, and added regression coverage in [ezgoDirect.test.ts](/Users/yoyopc/repos/availability-monitor/tests/ezgoDirect.test.ts).
- Verified live that the previously incorrect `reservationtN` `2026-04-01 -> 2026-04-03` 2-night case now returns `unavailable` with the correct intermediate-night signal.
